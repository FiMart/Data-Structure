...
def monitor(red, heat, mistake, blue, freeze):
    print('NORMAL :')
    print(len(red))
    print(''.join(str(x) for x in reversed(red)) if len(red) != 0 else 'Empty')
    ...
    print(''.join(str(x) for x in blue) if len(blue) != 0 else 'ytpmE')
...
if __name__ == '__main__':
    ...
    monitor(bomb_red, heat, mistake, bomb_blue, freeze)